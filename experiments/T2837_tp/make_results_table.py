...
system_name = 'T2837_tp_ddg_experimental'
...
for dataset in ['myoglobin', 'p53', 's669', 'ssym', 't2226', 'overall']:
    ...
    metadata_values = [f'T2837_tp - {dataset}', False, '-ddG stability', num_measurements_trace[-1], num_structures, True, False, 'overall']
