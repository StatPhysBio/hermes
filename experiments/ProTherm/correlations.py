...
if __name__ == '__main__':
    ...
    df = pd.read_csv(f'./{args.results_dir}/{args.model_version}/{args.system_name}_ddg_experimental-{model_version_in_filename}-use_mt_structure={args.use_mt_structure}.csv')
    ...
    # save correlations
    with open(f'./{args.results_dir}/{args.model_version}/{args.system_name}_ddg_experimental-{model_version_in_filename}-use_mt_structure={args.use_mt_structure}_correlations.json', 'w') as f:
